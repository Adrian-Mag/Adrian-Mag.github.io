...
(function () {
    ...
    var css = [
        ...
        "}",
        ".ai-assist-label {",
        "  color: rgba(255,255,255,0.45); margin-right: 0.2rem;",
        "}",
        ".ai-assist-btn {",
        "  display: inline-flex; align-items: center; gap: 0.35em;",
        "  padding: 0.28em 0.85em; border-radius: 999px;",
        "  background: rgba(103,145,190,0.13); color: #9dbbdd;",
        ...
        "}",
        ".ai-assist-btn:hover {",
        "  background: rgba(103,145,190,0.28); color: #cfe0f2;",
        "}",
        ".ai-assist-btn.copied {",
        "  background: rgba(110,190,130,0.2); color: #a9dcb7;",
