...
- Do not alter or delete the encrypted document vault; remove every route to it from the public CV.
...
The published asset is sanitised. Broader content and link improvements are intentionally deferred.
